...
namespace MVVMDataBinding
{
    public class CashRegisterModelView : INotifyPropertyChanged
    {
        ...
        /// </summary>
        public double TotalValue => drawer.TotalValue; // short hand of writing a getter
        ...
        public int Pennies
        {
            ...
            set
            {
                if (drawer.Pennies == value || value < 0) return; // if the amount hasnt changed or is negative
        ...
        public int Nickels
        {
            ...
            set
            {
                if (drawer.Nickels == value || value < 0) return; // if the amount hasnt changed or is negative
        ...
        public int Dimes
        {
            ...
            set
            {
                if (drawer.Dimes == value || value < 0) return; // if the amount hasnt changed or is negative
        ...
        public int Quarters
        {
            ...
            set
            {
                if (drawer.Quarters == value || value < 0) return; // if the amount hasnt changed or is negative
        ...
        public int HalfDollars
        {
            ...
            set
            {
                if (drawer.HalfDollars == value || value < 0) return; // if the amount hasnt changed or is negative
        ...
        public int Dollars
        {
            ...
            set
            {
                if (drawer.Dollars == value || value < 0) return; // if the amount hasnt changed or is negative
        ...
        public int Ones
        {
            ...
            set
            {
                if (drawer.Ones == value || value < 0) return; // if the amount hasnt changed or is negative
        ...
        public int Twos
        {
            ...
            set
            {
                if (drawer.Twos == value || value < 0) return; // if the amount hasnt changed or is negative
        ...
        public int Fives
        {
            ...
            set
            {
                if (drawer.Fives == value || value < 0) return; // if the amount hasnt changed or is negative
        ...
        public int Tens
        {
            ...
            set
            {
                if (drawer.Tens == value || value < 0) return; // if the amount hasnt changed or is negative
        ...
        public int Twenties
        {
            ...
            set
            {
                if (drawer.Twenties == value || value < 0) return; // if the amount hasnt changed or is negative
        ...
        public int Fifties
        {
            ...
            set
            {
                if (drawer.Fifties == value || value < 0) return; // if the amount hasnt changed or is negative
        ...
        public int Hundreds
        {
            ...
            set
            {
                if (drawer.Hundreds == value || value < 0) return; // if the amount hasnt changed or is negative
